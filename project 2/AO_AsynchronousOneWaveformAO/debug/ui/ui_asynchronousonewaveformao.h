/********************************************************************************
** Form generated from reading UI file 'asynchronousonewaveformao.ui'
**
...
#ifndef UI_ASYNCHRONOUSONEWAVEFORMAO_H
#define UI_ASYNCHRONOUSONEWAVEFORMAO_H
...
class Ui_AsynchronousOneWaveformAOClass
{
public:
    QFrame *background;
    ...
    void setupUi(QDialog *AsynchronousOneWaveformAOClass)
    {
        if (AsynchronousOneWaveformAOClass->objectName().isEmpty())
            AsynchronousOneWaveformAOClass->setObjectName(QStringLiteral("AsynchronousOneWaveformAOClass"));
        AsynchronousOneWaveformAOClass->resize(339, 430);
        AsynchronousOneWaveformAOClass->setMinimumSize(QSize(339, 430));
        AsynchronousOneWaveformAOClass->setMaximumSize(QSize(339, 430));
        background = new QFrame(AsynchronousOneWaveformAOClass);
        background->setObjectName(QStringLiteral("background"));
        background->setGeometry(QRect(-3, -3, 340, 431));
        background->setMinimumSize(QSize(340, 431));
        background->setStyleSheet(QStringLiteral("QFrame#background{background-image:url(:/AsynchronousOneWaveformAO/Resources/ao.png)}"));
        ...
        BtnSineA->setStyleSheet(QStringLiteral("background:url(:/AsynchronousOneWaveformAO/Resources/sine.png)"));
        ...
        BtnSquareA->setStyleSheet(QStringLiteral("background:url(:/AsynchronousOneWaveformAO/Resources/square.png)"));
        ...
        BtnTriangleA->setStyleSheet(QStringLiteral("background:url(:AsynchronousOneWaveformAO/Resources/triangle.png)"));
        ...
        BtnSineB->setStyleSheet(QStringLiteral("background:url(:/AsynchronousOneWaveformAO/Resources/sine.png)"));
        ...
        BtnTriangleB->setStyleSheet(QStringLiteral("background:url(:/AsynchronousOneWaveformAO/Resources/triangle.png)"));
        ...
        BtnSquareB->setStyleSheet(QStringLiteral("background:url(:/AsynchronousOneWaveformAO/Resources/square.png)"));
        ...
        retranslateUi(AsynchronousOneWaveformAOClass);

        QMetaObject::connectSlotsByName(AsynchronousOneWaveformAOClass);
    } // setupUi

    void retranslateUi(QDialog *AsynchronousOneWaveformAOClass)
    {
        AsynchronousOneWaveformAOClass->setWindowTitle(QApplication::translate("AsynchronousOneWaveformAOClass", "Asynchronous One Waveform AO", nullptr));
        ...
        txtboxHiLevelA->setText(QApplication::translate("AsynchronousOneWaveformAOClass", "5", nullptr));
        txtboxLoLevelA->setText(QApplication::translate("AsynchronousOneWaveformAOClass", "-5", nullptr));
        txtboxLoLevelB->setText(QApplication::translate("AsynchronousOneWaveformAOClass", "-5", nullptr));
        txtboxHiLevelB->setText(QApplication::translate("AsynchronousOneWaveformAOClass", "5", nullptr));
        chLabelA->setText(QApplication::translate("AsynchronousOneWaveformAOClass", "0", nullptr));
        chLabelB->setText(QApplication::translate("AsynchronousOneWaveformAOClass", "1", nullptr));
        btnConfigure->setText(QApplication::translate("AsynchronousOneWaveformAOClass", "Configure", nullptr));
        btnStart->setText(QApplication::translate("AsynchronousOneWaveformAOClass", "Start", nullptr));
    } // retranslateUi

};

namespace Ui {
    class AsynchronousOneWaveformAOClass: public Ui_AsynchronousOneWaveformAOClass {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ASYNCHRONOUSONEWAVEFORMAO_H
