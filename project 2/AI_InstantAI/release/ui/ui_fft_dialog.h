...
public:
    ...
    void setupUi(QDialog *fft_dialog)
    {
        ...
        lbl_fre_fs->setGeometry(QRect(700, 400, 31, 16));
        ...
        lbl_fre_hz = new QLabel(fft_dialog);
        lbl_fre_hz->setObjectName(QStringLiteral("lbl_fre_hz"));
        lbl_fre_hz->setGeometry(QRect(720, 400, 31, 16));
        lbl_fre_hz_2 = new QLabel(fft_dialog);
        lbl_fre_hz_2->setObjectName(QStringLiteral("lbl_fre_hz_2"));
        lbl_fre_hz_2->setGeometry(QRect(710, 160, 31, 16));
    ...
    void retranslateUi(QDialog *fft_dialog)
    {
        ...
        lbl_fs_2_neg->setText(QApplication::translate("fft_dialog", "0", nullptr));
        ...
        lbl_fre_hz->setText(QApplication::translate("fft_dialog", "Hz", nullptr));
        lbl_fre_hz_2->setText(QApplication::translate("fft_dialog", "Hz", nullptr));
    } // retranslateUi
