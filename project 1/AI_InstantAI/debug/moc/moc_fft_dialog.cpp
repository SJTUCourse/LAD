...
QT_MOC_LITERAL(4, 55, 8), // "FFT_show"
QT_MOC_LITERAL(5, 64, 24), // "ButttonSizeChangeClicked"
QT_MOC_LITERAL(6, 89, 14), // "SLideFreChange"
QT_MOC_LITERAL(7, 104, 15) // "SLideSizeChange"

    },
    "fft_dialog\0ButtonLowPassClicked\0\0"
    "ButtonHighPassClicked\0FFT_show\0"
    "ButttonSizeChangeClicked\0SLideFreChange\0"
    "SLideSizeChange"
};
...
void fft_dialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->FFT_show(); break;
        case 3: _t->ButttonSizeChangeClicked(); break;
        case 4: _t->SLideFreChange((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 5: _t->SLideSizeChange((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
